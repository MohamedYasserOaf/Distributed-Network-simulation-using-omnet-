...
void MyMessage::copy(const MyMessage& other)
{
    ...
    this->Node_Number = other.Node_Number;
...
void MyMessage::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->Node_Number);
    doParsimPacking(b,this->character_count);
}
...
void MyMessage::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->Node_Number);
    doParsimUnpacking(b,this->character_count);
}
...
int MyMessage::getNode_Number() const
{
    return this->Node_Number;
}

void MyMessage::setNode_Number(int Node_Number)
{
    this->Node_Number = Node_Number;
}

int MyMessage::getCharacter_count() const
{
    return this->character_count;
}

void MyMessage::setCharacter_count(int character_count)
{
...
int MyMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='N' && strcmp(fieldName, "Node_Number")==0) return base+4;
    if (fieldName[0]=='c' && strcmp(fieldName, "character_count")==0) return base+5;
...
std::string MyMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 4: return long2string(pp->getNode_Number());
        case 5: return long2string(pp->getCharacter_count());
        default: return "";
    }
}
...
bool MyMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 4: pp->setNode_Number(string2long(value)); return true;
        case 5: pp->setCharacter_count(string2long(value)); return true;
