...
class MyMessage : public ::omnetpp::cPacket
{
  ...
  public:
    ...
    virtual int getNode_Number() const;
    virtual void setNode_Number(int Node_Number);
    virtual int getCharacter_count() const;
    virtual void setCharacter_count(int character_count);
};
